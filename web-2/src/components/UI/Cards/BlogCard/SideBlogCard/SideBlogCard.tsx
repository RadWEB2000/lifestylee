...
import css from "@/ui/Cards/BlogCard/SideBlogCard/SideBlogCard.module.scss";
import styles from "@/ui/Cards/BlogCard/BlogCard.module.scss";
import Link from "next/link";

export default async function SideBlogCard(props: tCommonBlogCard) {
      ...
      <section className={css.main}>
        ...
        <p
          ...
          dangerouslySetInnerHTML={{
            __html: props.excerpt.substring(0, 105).trim() + "...",
          }}
