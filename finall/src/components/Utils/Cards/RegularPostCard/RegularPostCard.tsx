...
import css from "@/ui/Cards/RegularPostCard/RegularPostCard.module.scss";
      ...
      <section className={css.container}>
        <header className={css.head}>
          <ul className={css.taxonomy}>
            ...
            <Link className={css.subcategory} href="#">
              Kodowanie
            </Link>
          </ul>
          <h3 className={css.title}>
            Google’s Mueller Predicts Uptick Of Hallucinated Links: Redirect Or
            Not?
          </h3>
        </header>
